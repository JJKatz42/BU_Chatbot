...
import storage_data_classes as data_classes
...
class WebpageSplitterTransformer:
    ...
    def transform(self, Webpage: data_classes.Webpage):
        ...
        Webpage.text_contents = [
            data_classes.TextContent(text=chunk, index=chunk_index)
